...
An interactive Power BI dashboard can be downloaded below here [Sales Dashboard](reports_and_analytics/Sales_Dashboard.pbix) & [Customer Dashboard](reports_and_analytics/Customer_Dashboard.pbix)
